    ...
    <div class="pad-x" id="login-container">
        ...
        <div class="form-box">
            <div class="form-heading">
                <img src="../img/icons/adminDark.png" alt="Admin-img" id="admin-img" class="admin-img">
            ...
            <form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="POST">
                ...
                <div class="form-element">
                    ...
                    <div class="links">
                        <input type="checkbox" name="employee-check" id="employee-check" value="employee-check"><span>Are you Employee?</span>
                        <a href="_adminForget.php" class="forgot-pass">Forgot Password</a>
                    </div>
                </div>
            </form>
            <hr class="form-line">
